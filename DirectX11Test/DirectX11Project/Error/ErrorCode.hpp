...
namespace Lobelia {
	enum class ErrorCode {
		...
		DXE00019,					//コンピュートシェーダーの作成に失敗
		DXE00020,					//ジオメトリシェーダーの作成に失敗
		//400~入力系初期化
		DXE00400 = 400,			//Direct Inputデバイスの作成に失敗
		DXE00401,					//入力デバイスの作成に失敗
		DXE00402,					//入力デバイスのデータ設定に失敗
		DXE00403,					//協調レベルの設定に失敗
		DXE00404,					//プロパティの設定に失敗
		DXE00405,					//入力デバイスの情報取得に失敗
		DXE00406,					//範囲外のキーコードが設定されました
		//1000 ~ 19999 実行時エラー
