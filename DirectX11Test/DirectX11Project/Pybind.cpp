...
PYBIND11_MODULE(DirectX11, m) {
	...
	py::class_<GPUParticleSystem::Particle>(m, "GPUParticle")
		...
		.def_readwrite("posZ", &GPUParticleSystem::Particle::posZ)
		.def_readwrite("moveX", &GPUParticleSystem::Particle::moveX)
		.def_readwrite("moveY", &GPUParticleSystem::Particle::moveY)
		.def_readwrite("moveZ", &GPUParticleSystem::Particle::moveZ)
		.def_readwrite("powerX", &GPUParticleSystem::Particle::powerX)
		.def_readwrite("powerY", &GPUParticleSystem::Particle::powerY)
		.def_readwrite("powerZ", &GPUParticleSystem::Particle::powerZ)
		.def_readwrite("textureIndex", &GPUParticleSystem::Particle::textureIndex)
		.def_readwrite("uvPosX", &GPUParticleSystem::Particle::uvPosX)
		.def_readwrite("uvPosY", &GPUParticleSystem::Particle::uvPosY)
		.def_readwrite("uvSizeX", &GPUParticleSystem::Particle::uvSizeX)
		.def_readwrite("uvSizeY", &GPUParticleSystem::Particle::uvSizeY)
		...
		.def_readwrite("colorRed", &GPUParticleSystem::Particle::colorRed)
		.def_readwrite("colorGreen", &GPUParticleSystem::Particle::colorGreen)
		.def_readwrite("colorBlue", &GPUParticleSystem::Particle::colorBlue);
	py::class_<GPUParticleSystem>(m, "GPUParticleSystem")
		.def(py::init())
		.def("LoadTexture", &GPUParticleSystem::LoadTexture)
		.def("GetElapsedTime", &GPUParticleSystem::GetElapsedTime)
